...
const cheerio = require('cheerio')
 ...
 module.exports = {
	...
	getRequestUrl: ({story, chapter = 1}) => `http://hpfanficarchive.com/stories/viewstory.php?sid=${story}&chapter=${chapter}`,
	get: async url => {
		const page = await axios.get(url, {withCredentials: true})
